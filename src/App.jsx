...
function AppContent() {
  ...
  const location = useLocation();
  const showNavBar = !user && ['/', '/discover', '/spaces', '/safety', '/support', '/login', '/register'].includes(location.pathname);
    ...
    <>
      <div className="tavora-route-view">
        <Routes>
          {user ? (
            <>
              <Route path="/login" element={<AuthedAuthRedirect />} />
              <Route path="/register" element={<Navigate to="/home" replace />} />
              <Route element={<AppShell />}>
                <Route path="/" element={<ShellChild />} />
                <Route path="/home" element={<ShellChild />} />
                <Route path="/:sessionId/home" element={<ShellChild />} />
                <Route path="/dm/:userId" element={<ShellChild />} />
                <Route path="/settings/*" element={<ShellChild />} />
                <Route path="/server/:serverId/channel/:channelId" element={<ShellChild />} />
                <Route path="/server/:serverId/:channelId" element={<ShellChild />} />
                <Route path="/server/:serverId" element={<ShellChild />} />
                <Route path="/discover" element={<ShellChild />} />
                <Route path="/spaces" element={<ShellChild />} />
                <Route path="/safety" element={<ShellChild />} />
                <Route path="/support" element={<ShellChild />} />
                <Route path="/invite/:inviteId" element={<ShellChild />} />
              </Route>
            </>
          ) : (
            <>
